...
class HitPay 
{
    ...
    protected $curl;
    protected $endpoint         = 'https://api.hit-pay.com/';   //// 'https://api.hit-pay.com/';
    protected $endpointSandbox  = 'http://securecheckout.sandbox.hit-pay.com/payment-request/@test-1/';    ////   'https://api.staging.hit-pay.com/';
	...
	**/
    ...
    if ($errorNumber == 0){
		...
		$msg = array('message' => 'Success', 'logged_in_user_id' => $data['logged_in_user_id'], 'amount' => $data['amount'], 'currency' => $data['currency'], 'created_date' => $data['created_date']);
        return $msg;
       //return $data;
    }
