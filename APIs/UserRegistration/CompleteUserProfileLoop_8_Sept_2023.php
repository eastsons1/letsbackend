...
function mime2ext($mime){
    ...
    return false;
			...
			{	
				$query = "INSERT INTO `user_tutor_info` (user_id,profile_image,age,gender,nationality,qualification,name_of_school,Course_Exam,gra_year,tutor_status,tuition_type,location,postal_code,travel_distance,personal_statement,lettitude,longitude,stream,tutor_code) VALUES " . implode(', ', $arrayV);  
			}
