...
header('content-type:application/json');
			...
			$query = "SELECT * FROM student_post_requirements order by booked_date ASC ";
			...
			if($numrows > 0)
			{
				...
				while($tutor_result = mysqli_fetch_assoc($result))
				{
					...
					if($tutor_result['assigned_favourite_by_tutor']== "false" || $tutor_result['assigned_favourite_by_tutor']== "")
					{
						$assigned_favourite_by_tutor = 'false';
