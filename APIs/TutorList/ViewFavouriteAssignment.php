...
header('content-type:application/json');
		...
		if($_GET['logged_in_tutor_id'] !="")
		{
	
			$query = "SELECT * FROM student_post_requirements where assigned_favourite_by_tutor_id = '".$_GET['logged_in_tutor_id']."' ";
			...
			if($numrows > 0)
			{
				...
				while($tutor_result = mysqli_fetch_assoc($result))
				{
					...
					if($tutor_result['assigned_favourite_by_tutor']== "true" )
					{
						$assigned_favourite_by_tutor = 'true';
						$assigned_favourite_by_tutor_id = $tutor_result['assigned_favourite_by_tutor_id'];
						...
						$Response[] = array(
										...
										'tutor_id' => $tutor_result['assigned_favourite_by_tutor_id'],
										...
										'tutor_booking_status' => $tutor_result['tutor_booking_status'],
										'offer_status' => $tutor_result['offer_status'],
										'assigned_favourite_by_tutor' => $assigned_favourite_by_tutor,
										'assigned_favourite_by_tutor_id' => $assigned_favourite_by_tutor_id,
			...
			else 
			{
				...
				$resultData = array('status' => false, 'message' => 'Tutor id can not be blank.');
		}
