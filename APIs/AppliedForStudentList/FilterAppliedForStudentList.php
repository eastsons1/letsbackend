...
header('content-type:application/json');
			...
			$student_post_requirements_id = $_GET['student_post_requirements_id'];
			
			if($student_login_id !="" && $student_post_requirements_id !="" )
			{	
				...
				$query = "SELECT * FROM student_post_requirements WHERE logged_in_user_id = '".$student_login_id."' and student_post_requirements_id = '".$student_post_requirements_id."'  ";
			...
			{
				$resultData = array('status' => false, 'message' => 'Student login id and Student post requirements id can not be blank.');
			}
