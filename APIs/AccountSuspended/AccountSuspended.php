...
header('content-type:application/json');
  ...
  {
	  $check = $conn->query("SELECT * FROM user_info WHERE user_id = '".$user_login_id."' and user_type = '".$user_type."' ");
	  ...
	  if(mysqli_num_rows($check)>0)
	  {
		  ...
		  $account_suspend = $conn->query("INSERT INTO tbl_user_suspended SET user_id = '".$user_login_id."', user_type = '".$user_type."', account_suspended = 'suspended', created_date = '".$created_date."'  ");
