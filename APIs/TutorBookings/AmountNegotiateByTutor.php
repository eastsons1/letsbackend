...
header('content-type:application/json');
		...
		if($_POST['tutor_id'] !="" && $_POST['student_id'] !="" && $_POST['tutor_tution_offer_amount_type'] !="" && $_POST['tutor_tution_offer_amount'] !="" && $_POST['amount_negotiate_by_tutor'] !="")
		{
			...
			$resultData = array('status' => false, 'message' => 'Tutor id, Student id, Tutor Tution Offer Amount Type, Tutor Tution Offer Amount and Amount Negotiate By Tutor  can\'t be blank.');
		}	
